...
const appdata = JSON.parse(document.getElementById('app').dataset.page);
const props = Helper.decrypt(appdata.props);
console.log(props);
if(props && props.auth && props.auth.user){
	...
	store.dispatch('user/setUserToken',props.auth.user.id);
}
